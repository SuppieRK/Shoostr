...
public class ContentTooLargeException extends HttpClientException {
   ...
   */
  public ContentTooLargeException(@Nullable String message) {
    this(message, null);
  }
   ...
   * @param cause underlying failure, or null
   */
  public ContentTooLargeException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.CONTENT_TOO_LARGE, message, cause);
  }
}
