 ...
 * HTTP 423: Locked.
 *
 * @see HttpStatusCodes#LOCKED
 */
public class LockedException extends HttpClientException {
   ...
   */
  public LockedException(@Nullable String message) {
    this(message, null);
  }
   ...
   * @param cause underlying failure, or null
   */
  public LockedException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.LOCKED, message, cause);
  }
}
