 ...
 *
 * @see HttpStatusCodes#BAD_REQUEST
 */
public class BadRequestException extends HttpClientException {
   ...
   * @param cause underlying failure, or null
   */
  public BadRequestException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.BAD_REQUEST, message, cause);
  }
}
