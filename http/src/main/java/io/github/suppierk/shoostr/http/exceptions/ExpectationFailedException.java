...
public class ExpectationFailedException extends HttpClientException {
   ...
   */
  public ExpectationFailedException(@Nullable String message) {
    this(message, null);
  }
   ...
   * @param cause underlying failure, or null
   */
  public ExpectationFailedException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.EXPECTATION_FAILED, message, cause);
  }
}
