 ...
 *
 * @see HttpStatusCodes#TOO_MANY_REQUESTS
 */
public class TooManyRequestsException extends HttpClientException {
   ...
   */
  public TooManyRequestsException(@Nullable String message) {
    this(message, null);
  }
   ...
   * @param cause underlying failure, or null
   */
  public TooManyRequestsException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.TOO_MANY_REQUESTS, message, cause);
  }
}
