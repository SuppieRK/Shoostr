...
public class UnprocessableContentException extends HttpClientException {
   ...
   */
  public UnprocessableContentException(@Nullable String message) {
    this(message, null);
  }
   ...
   */
  public UnprocessableContentException(@Nullable Throwable cause) {
    this(null, cause);
  }
   ...
   * @param cause underlying failure, or null
   */
  public UnprocessableContentException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.UNPROCESSABLE_CONTENT, message, cause);
  }
}
