 ...
 *
 * @see HttpStatusCodes#PROXY_AUTHENTICATION_REQUIRED
 */
public class ProxyAuthenticationRequiredException extends HttpClientException {
   ...
   */
  public ProxyAuthenticationRequiredException(@Nullable String message) {
    this(message, null);
  }
   ...
   * @param cause underlying failure, or null
   */
  public ProxyAuthenticationRequiredException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.PROXY_AUTHENTICATION_REQUIRED, message, cause);
  }
}
