...
public class HttpVersionNotSupportedException extends HttpServerException {
   ...
   */
  public HttpVersionNotSupportedException(@Nullable String message) {
    this(message, null);
  }
   ...
   * @param cause underlying failure, or null
   */
  public HttpVersionNotSupportedException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.HTTP_VERSION_NOT_SUPPORTED, message, cause);
  }
}
