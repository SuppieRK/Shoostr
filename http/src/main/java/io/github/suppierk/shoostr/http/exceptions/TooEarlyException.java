...
public class TooEarlyException extends HttpClientException {
   ...
   */
  public TooEarlyException(@Nullable String message) {
    this(message, null);
  }
   ...
   * @param cause underlying failure, or null
   */
  public TooEarlyException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.TOO_EARLY, message, cause);
  }
}
