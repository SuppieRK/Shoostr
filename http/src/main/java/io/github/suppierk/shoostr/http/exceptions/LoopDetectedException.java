 ...
 *
 * @see HttpStatusCodes#LOOP_DETECTED
 */
public class LoopDetectedException extends HttpServerException {
   ...
   */
  public LoopDetectedException(@Nullable String message) {
    this(message, null);
  }
   ...
   * @param cause underlying failure, or null
   */
  public LoopDetectedException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.LOOP_DETECTED, message, cause);
  }
}
