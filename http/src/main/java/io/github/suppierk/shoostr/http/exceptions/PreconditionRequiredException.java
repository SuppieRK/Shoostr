 ...
 *
 * @see HttpStatusCodes#PRECONDITION_REQUIRED
 */
public class PreconditionRequiredException extends HttpClientException {
   ...
   */
  public PreconditionRequiredException(@Nullable String message) {
    this(message, null);
  }
   ...
   * @param cause underlying failure, or null
   */
  public PreconditionRequiredException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.PRECONDITION_REQUIRED, message, cause);
  }
}
