...
public class RequestHeaderFieldsTooLargeException extends HttpClientException {
   ...
   */
  public RequestHeaderFieldsTooLargeException(@Nullable String message) {
    this(message, null);
  }
   ...
   * @param cause underlying failure, or null
   */
  public RequestHeaderFieldsTooLargeException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.REQUEST_HEADER_FIELDS_TOO_LARGE, message, cause);
  }
}
