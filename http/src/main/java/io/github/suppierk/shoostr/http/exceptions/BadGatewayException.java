 ...
 *
 * @see HttpStatusCodes#BAD_GATEWAY
 */
public class BadGatewayException extends HttpServerException {
   ...
   */
  public BadGatewayException(@Nullable String message) {
    this(message, null);
  }
   ...
   * @param cause underlying failure, or null
   */
  public BadGatewayException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.BAD_GATEWAY, message, cause);
  }
}
