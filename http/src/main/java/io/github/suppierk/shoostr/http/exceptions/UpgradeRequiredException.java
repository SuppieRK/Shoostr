 ...
 *
 * @see HttpStatusCodes#UPGRADE_REQUIRED
 */
public class UpgradeRequiredException extends HttpClientException {
   ...
   */
  public UpgradeRequiredException(@Nullable String message) {
    this(message, null);
  }
   ...
   * @param cause underlying failure, or null
   */
  public UpgradeRequiredException(@Nullable String message, @Nullable Throwable cause) {
    super(HttpStatusCodes.UPGRADE_REQUIRED, message, cause);
  }
}
